...
| Phase 2: Rephrase | **Complete** | — | AI-powered rewrite via Sonnet, opens Edit & Resend box. See [`tasks/agentic-right-click-context-menu-phase2-rephrase.md`](tasks/agentic-right-click-context-menu-phase2-rephrase.md) |
